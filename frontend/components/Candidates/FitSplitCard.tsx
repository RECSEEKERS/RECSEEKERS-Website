    ...
    icon: (active) => (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m15.75 15.75-2.489 2.489a3.375 3.375 0 0 1-4.773 0l-2.227-2.227a3.375 3.375 0 0 1 0-4.773l2.489-2.489m3.75 7.5 2.489-2.489a3.375 3.375 0 0 0 0-4.773l-2.227-2.227a3.375 3.375 0 0 0-4.773 0L8.25 8.25"
        />
      </svg>
    ),
  },
